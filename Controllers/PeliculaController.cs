...
namespace back_1_trimestre_2_daw.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        { 
            ...
            peliculas.Add(new Pelicula( 21, "Mi Pobre Angelito", "Un niño es olvidado en casa y defiende su hogar de dos ladrones durante Navidad.", "Macaulay Culkin, Joe Pesci y Daniel Stern", "Chris Columbus", 1.43, 4.50, "7", "../images/Mi_Pobre_Angelito.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 22, "Milagro en la Calle 34", "Un hombre que asegura ser Santa Claus intenta demostrar su identidad.", "Edmund Gwenn, Maureen O'Hara y Natalie Wood", "George Seaton", 1.36, 3.50, "0", "../images/Milagro_en_la_Calle_34.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 23, "El Expreso Polar", "Un niño aborda un tren mágico hacia el Polo Norte en Nochebuena.", "Tom Hanks, Chris Coppola y Michael Jeter", "Robert Zemeckis", 1.40, 4.20, "0", "../images/El_Expreso_Polar.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 24, "Santa Cláusula", "Un hombre accidentalmente se convierte en Santa Claus tras un accidente en Nochebuena.", "Tim Allen, Wendy Crewson y Judge Reinhold", "John Pasquin", 1.37, 3.80, "0", "../images/Santa_Clausula.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 25, "El Origen de los Guardianes", "Un grupo de personajes legendarios debe proteger la Navidad de una fuerza oscura.", "Chris Pine, Alec Baldwin y Hugh Jackman", "Peter Ramsey", 1.37, 4.70, "7", "../images/El_Origen_de_los_Guardianes.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 26, "Un Padre en Apuros", "Un padre desesperado busca el regalo perfecto en Nochebuena.", "Arnold Schwarzenegger, Sinbad y Phil Hartman", "Brian Levant", 1.29, 3.60, "7", "../images/Un_Padre_en_Apuros.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 27, "Navidad con los Cooper", "Una familia disfuncional intenta pasar una perfecta noche de Navidad.", "Diane Keaton, John Goodman y Ed Helms", "Jessie Nelson", 1.47, 4.00, "13", "../images/Navidad_con_los_Cooper.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 28, "Klaus", "Un joven cartero forma una improbable amistad con un fabricante de juguetes en una remota aldea.", "Jason Schwartzman, J.K. Simmons y Rashida Jones", "Sergio Pablos", 1.37, 4.90, "0", "../images/Klaus.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 29, "Noelle", "La hija de Santa Claus debe salvar la Navidad tras la desaparición de su hermano.", "Anna Kendrick, Bill Hader y Shirley MacLaine", "Marc Lawrence", 1.40, 4.30, "7", "../images/Noelle.png", 5, "Navideña" )); 
            peliculas.Add(new Pelicula( 30, "El Regalo Prometido", "Un padre busca desesperadamente el juguete más popular de la temporada para su hijo.", "Arnold Schwarzenegger, Sinbad y Phil Hartman", "Brian Levant", 1.29, 3.90, "7", "../images/El_Regalo_Prometido.png", 5, "Navideña" ));
